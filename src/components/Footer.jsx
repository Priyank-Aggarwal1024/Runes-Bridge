    ...
    return (
        <div className="xl:pt-[53px] pt-4 xl:px-[67px] gap-[29px] flex flex-col w-full max-w-full">
            <div className="flex gap-3 items-center xl:justify-start justify-center">
                <div className="text-black lg:text-[80px] h-fit xxs:text-[40px] md:text-[60px] text-[32px] xl:text-[120px] font-extrabold font-['Bricolage Grotesque'] leading-[150%]">
                    Connect with
                </div>
                <img src={logol} className="lg:block hidden" alt="Large Logo" />
            </div>
            <div className="flex max-w-full md:flex-row flex-col w-full gap-6 xl:gap-[148px] lg:gap-[64px] xlg:gap-[211px] px-4">
