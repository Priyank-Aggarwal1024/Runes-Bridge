...
function Sidebar() {
    ...
    return (
        <div className="flex md:flex-col items-center md:w-[unset] w-full">
            <Link to={"/deposit"} className={`w-[255px] max-w-full md:h-14 md:pr-10 xxs:pr-2 xxs:pl-4 pr-1.5 pl-1.5 md:py-4 py-1.5 bg-white rounded-xl justify-between items-center gap-6 hidden md:inline-flex ${pathname == "/deposit" ? "bg-[#5A585A] text-white" : "bg-white text-[#0f0f0f]"}`}>
            ...
            <Link to={"/withdraw"} className={`w-[255px] max-w-full md:h-14 md:pr-10 xxs:pr-2 xxs:pl-4 pr-1.5 pl-1.5 md:py-4 py-1.5 bg-white rounded-xl justify-between items-center gap-6 inline-flex ${pathname == "/withdraw" ? "bg-[#5A585A] text-white" : "bg-white text-[#0f0f0f]"}`}>
                <div className="h-6 justify-start items-center gap-2 flex">
            ...
            <Link to={"/airdrop"} className={`w-[255px] max-w-full md:h-14 md:pr-10 xxs:pr-2 xxs:pl-4 pr-1.5 pl-1.5 md:py-4 py-1.5 bg-white rounded-xl justify-between items-center gap-6 inline-flex ${pathname == "/airdrop" ? "bg-[#5A585A] text-white" : "bg-white text-[#0f0f0f]"}`}>
                <div className="h-6 justify-start items-center gap-2 flex">
            ...
            <Link to={"/history"} className={`w-[255px] max-w-full md:h-14 md:pr-10 xxs:pr-2 xxs:pl-4 pr-1.5 pl-1.5 md:py-4 py-1.5 bg-white rounded-xl justify-between items-center gap-6 inline-flex ${pathname == "/history" ? "bg-[#5A585A] text-white" : "bg-white text-[#0f0f0f]"}`}>
                <div className="h-6 justify-start items-center gap-2 flex">
